                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('cedula') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control" name="cedula" value="<?php echo e(old('cedula')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('edad') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="edad" type="text" class="form-control" name="edad" value="<?php echo e(old('edad')); ?>" required autofocus>
